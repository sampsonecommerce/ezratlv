...
if (created) {
  ...
  check(c.phone_mm6dxgj2?.phone === "0501234567", "phone missing or not in the one shape");
...
if (created) {
  ...
  check(c.phone_mm6dxgj2?.phone === "0502223344", "RSVP phone missing or not in the one shape");
